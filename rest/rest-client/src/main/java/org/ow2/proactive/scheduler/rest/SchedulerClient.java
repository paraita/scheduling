...
public class SchedulerClient extends ClientBase implements ISchedulerClient {
    ...
    public boolean isTaskFinished(String jobId, String taskName)
        ...
        try {
            TaskStateData taskStateData = restJobTaskApi().jobtasks(sid, jobId, taskName);
    ...
    private SchedulerTasksRestInterface restJobTaskApi() {
        return schedulerRestClient.getJobTaskScheduler();
    }
